...
// ===== COMPLETE POOKIE ARMY DASHBOARD =====
...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .status-card .icon { font-size: 3em; display: block; }
...
<div class="container">
  ...
  <div id="tab-rename" class="tab-content">
    <div style="text-align:center;">
      ...
      <button onclick="resetNames()" style="background:linear-gradient(135deg,#ff8800,#cc6600);">↩️ Reset</button>
    </div>
  </div>

  <div class="footer">🌸 <strong>RINTU'S ARMY</strong> · v6.0 · 💕</div>
</div>
...
app.post('/api/remove-token', auth, (req, res) => {
  ...
  if (sessions[req.userId]?.[id]) {
    sessions[req.userId][id].destroy?.();
